 ...
 * @param FilterDeleted
 */
angular.module('redPandaApp').controller('customerDetailController', ['$scope','$rootScope','$modal','$http','$location','$cookieStore','$filter','$anchorScroll', 'CurrentTimeStamp','$timeout', function($scope,$rootScope,$modal,$http,$location,$cookieStore,$filter,$anchorScroll,  CurrentTimeStamp,$timeout,FilterDeleted){ 
    ...
    $scope.deleteContractList = function(obj, index) {
        ...
        $scope.$watch('isPostSuccess', function(nValue, oValue) {
            ...
            if ($rootScope.isPostSuccess) {
                ...
                var activeContractList = FilterDeleted.filter($scope.CustomerDetail.data.contractList);
    ...
    if ($cookieStore.get("detailId") == 'create') {
        ...
        if ($rootScope.fromCustomer) {
            ...
            $scope.contractTableData = activeContractList; //$scope.CustomerDetail.data.contractList;
