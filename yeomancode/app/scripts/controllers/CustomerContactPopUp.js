 ...
 */
//======================================================================================================//
angular.module('redPandaApp').controller('ContactModalController', ['$scope', '$rootScope', '$route', '$http', 'CurrentTimeStamp', '$cookieStore',
    function($scope, $rootScope, $route, $http, CurrentTimeStamp, $cookieStore) {
