 ...
 * google-maps - Module for displaying google maps
 * ngCookies - Module used for storing the values in cookies.
 * colorPicker - Module used for colopicker
 */
var redPanda = angular.module("redPandaapp", ['ngRoute', 'ui.calendar', 'ui.bootstrap', 'ngGrid', 'google-maps', 'ngCookies', 'colorpicker.module']);

/**
 * Function used to make routing configurations
 * @param $routeProvider - service used to route the pages based on the url changes
 */
function routeconfig($routeProvider) {
    $routeProvider.when('/', {
        ...
        templateUrl: '../Manage/EmployeeDetail/EmployeeDetail.html'
    }).when('/Customer', {
        templateUrl: '../Manage/Customer/Customer.html'
    }).when('/CustomerDetail', {
        templateUrl: '../Manage/CustomerDetail/CustomerDetail.html'
    }).when('/Contract', {
        templateUrl: '../Manage/Contract/Contract.html'
    }).when('/ContractDetail', {
        templateUrl: '../Manage/ContractDetail/ContractDetail.html'
    }).otherwise({
        redirectTo: '../Home/HomePage.html'
    });
}

/**
 * Configuration for the module redPanda
 */
redPanda.config(routeconfig);
 ...
 * @param $http
 */
redPanda.controller('maincontroller', function($scope, $location, $rootScope, $cookieStore, $window, $modal, $http) {
 ...
 */
redPanda.directive('datepickers', function() {
    return {
        restrict: 'A',
 ...
 */
redPanda.directive('xeditable', function($timeout) {
    return {
        restrict: 'A',
        require: "ngModel",
 ...
 */
redPanda.directive('dropdownMultiselect', function() {
    return {
        restrict: 'E',
        scope: {
            model: '=',
 ...
 */
redPanda.directive('isStdtimeTwodp', function() {
    return {
        require: 'ngModel',
 ...
 */
redPanda.directive('hourlyRate', function() {
    return {
        require: 'ngModel',
 ...
 */
redPanda.directive('isValue', function() {
    return {
        require: 'ngModel',
 ...
 * For handling 2dp value for overtime cost
 */
redPanda.directive('isOvertimeTwodp', function() {
    return {
        require: 'ngModel',
        link: function(scope, element) {
 ...
 */
redPanda.directive("ngFileSelect", function() {
    return {
 ...
 */
redPanda.directive("numbersOnly", function() {
    return {
        require: 'ngModel',
 ...
 */
redPanda.service('CurrentTimeStamp', function() {
 ...
 */
redPanda.service('FilterDeleted', function() {
 ...
 * Conversion of mm-dd-yyy format to ISO format
 */
redPanda.service('USDateFormat', function() {
